...
def main():
    ...
    # TESTES PARA SERIES REAIS
    caminho_arquivo = 'E:/Workspace2/GMMO/projects/new/teste.xlsx'
    caminho_salvar = 'E:/Workspace2/GMMO/projects/new/'
    
    #geral
    labels, acuracias = tbt.obter_dados_arquivo(caminho_arquivo, [1, 36], [0, 2]) 
